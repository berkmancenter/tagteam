...
* git clone https://github.com:berkmancenter/taghub.git tagteam && cd tagteam && bundle
* Review config/environments/production.rb to set values that make sense for your domain. 
...
* Start up your resque workers:
* resque-pool --daemon --environment production 
* Set up the cron jobs that cause the file-based cache to expire and feeds to get updated. 
...
* https://github.com/berkmancenter/taghub
