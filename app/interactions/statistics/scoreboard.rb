  ...
  class Scoreboard < ActiveInteraction::Base
    ...
    def set_criteria
      case @criteria
        ...
        when 'Week'
          1.week.ago.beginning_of_day..(1.week.ago + 7.day).end_of_day
        when 'Month'
          1.month.ago.beginning_of_day..(1.week.ago + 30.day).end_of_day
        when 'Year'
          1.year.ago.beginning_of_day..(1.year.ago + 365.day).end_of_day         
      end 
    end
  end
end