class FeedItemsController < ApplicationController
  ...
  caches_action :content, :related, :index, :show, :unless => Proc.new{|c| current_user && current_user.is?([:owner,:remixer, :hub_feed_item_tag_filterer], @hub)}, :expires_in => DEFAULT_ACTION_CACHE_TIME, :cache_path => Proc.new{ 
